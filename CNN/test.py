...
if __name__ == '__main__':
    ...
    if args.type == 'baseline':
        net.load_state_dict(torch.load('./CNN_CheckPoint/Checkpoint.pth')['net'])
    elif args.type == 'cutout':
        net.load_state_dict(torch.load('./CNN_CheckPoint/Cutout_checkpoint.pth')['net'])
    elif args.type == 'cutmix':
        net.load_state_dict(torch.load('./CNN_CheckPoint/Cutmix_checkpoint.pth')['net'])
    else:
        net.load_state_dict(torch.load('./CNN_CheckPoint/Cutmix_checkpoint.pth')['net'])
    print(net)
    net.eval()
